...
class LPDDR5PIM : public DRAMSpec {
 public:
  ...
  struct Timing {
    ...
    nPBR2PBR, nPBR2ACT, nPIM_MAC_LAT, nPIM_MAC_II, COUNT
    };
  };
  ...
  LPDDR5PIM(const ConfigNode& config) {
    ...
    set_names(timings, timing_names, {
        ...
        "nREFI", "nREFIpb", "nWCKPST", "nCAS", "nAAD", "nCS", "tCK_ps", "nPBR2PBR", "nPBR2ACT", "nPIM_MAC_LAT",
        "nPIM_MAC_II"
    });
