...
class HBM3 : public DRAMSpec {
 public:
  ...
  struct Timing {
    ...
    nPPD, nBTR, nRFC, nRFCpb, nRFMab, nRFMpb, nRREFD, nREFI, nREFIpb, tCK_ps, COUNT
    };
  };
  ...
  using CommandImpls = std::tuple<
      Cmd::ACT<HBM3>, Cmd::PREpb<HBM3>, Cmd::PREab<HBM3>, Cmd::RD<HBM3>, Cmd::WR<HBM3>, Cmd::RDA<HBM3>,
  ...
  HBM3(const ConfigNode& config) {
    ...
    set_names(timings, timing_names, {
        ...
        "nRRDS", "nRRDL", "nWTRS", "nWTRL", "nFAW", "nPPD", "nBTR", "nRFC", "nRFCpb", "nRFMab", "nRFMpb", "nRREFD",
        "nREFI", "nREFIpb", "tCK_ps"
    });
...
// Self-registration
static bool _dram_hbm3 = DRAMSpec::register_standard(
    "HBM3", [](const ConfigNode& config) { return std::make_unique<HBM3>(config); });
